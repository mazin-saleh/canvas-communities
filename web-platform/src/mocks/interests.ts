...
export const mockInterests: Interest[] = [
  // Academics / Majors
  { id: "cs", label: "Computer Science", category: "Academics", selected: false },
  { id: "datasci", label: "Data Science", category: "Academics", selected: false },
  { id: "swe", label: "Software Engineering", category: "Academics", selected: false },
  { id: "aiml", label: "AI / Machine Learning", category: "Academics", selected: false },
  ...
  { id: "psych", label: "Psychology", category: "Academics", selected: false },
  ...
  { id: "mecheng", label: "Mechanical Engineering", category: "Academics", selected: false },
  ...
  { id: "robotics", label: "Robotics Engineering", category: "Academics", selected: false },
  { id: "premed", label: "Pre-Med", category: "Academics", selected: false },
  { id: "prelaw", label: "Pre-Law", category: "Academics", selected: false },
  { id: "entre", label: "Entrepreneurship", category: "Academics", selected: false },

  // Interests & Hobbies
  { id: "photo", label: "Photography", category: "Interests & Hobbies", selected: false },
  { id: "music", label: "Music", category: "Interests & Hobbies", selected: false },
